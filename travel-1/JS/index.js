console.log('ИТОГО 100, в т.ч.\n
	1. Bёрстка валидная +10\n
...
В коде странице присутствуют следующие элементы:\n
    ...
    2. Вёрстка соответствует макету +48\n
        ◦ блок <header> +6\n
        ◦ секция preview +9\n
        ◦ секция steps +9\n
    ...
    3. Требования к css + 10\n
        ...
        ◦  нет favicon 0\n
    4. Интерактивность, реализуемая через css +20\n
        ...
        ◦ интерактивность включает в себя не только изменение внешнего вида курсора, например, при помощи свойства cursor: pointer, но и другие визуальные эффекты, например, изменение цвета фона или цвета шрифта. Если в макете указаны стили при наведении и клике, для элемента указываем эти стили.\n Если в макете стили не указаны, реализуете их по своему усмотрению, руководствуясь общим стилем макета +5\n
